...
reported to the project maintainer by opening a GitHub issue titled
`[CONDUCT] <short description>` or, for sensitive matters, via GitHub's
private vulnerability/report tooling on this repository. All complaints will
